			...
			<div class="col-8 pl-2" id="mainDiv">
				...
				<form>
					<div class="row" id="optionDiv">
						<div class="col">
							<label>A. <input type="radio" name="question1" value="A"> Accra</label><br>
							<label>B. <input type="radio" name="question1" value="B"> Washington DC</label><br>
							<label>C. <input type="radio" name="question1" value="C"> Paris</label><br>
							<label>D. <input type="radio" name="question1" value="D"> London</label><br>
						</div>
					</div>
