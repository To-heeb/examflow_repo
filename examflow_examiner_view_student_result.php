...
<body>
					...
					<table class="table table-hover table-striped table-light table-bordered text-bold w-100 d-block d-md-table" >
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center"><a href="#" class="btn btn-primary btn-sm" id="viewResult" data-id="<?php echo $value['student_id'];?>" data-exam="<?php echo $exam_id ;?>" data-name="<?php echo $value['student_lname']." ".$value['student_fname']; ?>"  data-toggle='modal' data-target='#resultModal' data-title="<?php echo $exam_title; ?>">View Result</a></td>
							</tr>
							<?php
							}	
	...
	<script type="text/javascript" language="javascript">
		$(document).ready(function(){
			...
			jQuery(document).on('click', '[id^=viewResult]',function(){
				//alert('I got here');
				...
				$.ajax({
					...
					type: "POST",
					data: "examinerViewResultPage=examinerViewResult&student_id="+student_id+"&exam_id="+exam_id+"&student_name="+student_name+"&exam_title="+exam_title,
